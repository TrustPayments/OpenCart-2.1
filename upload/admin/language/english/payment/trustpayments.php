...
$_['description_events']							= "This modification simulates events which exist in later Opencart versions, but are not present in 2.1.x. Due to the nature of this modification all modifications must be refreshed twice.";
