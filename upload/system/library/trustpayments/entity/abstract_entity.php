...
abstract class AbstractEntity {
	...
	protected static function query($query, $db){
		set_error_handler('TrustPaymentsHelper::exceptionErrorHandler');
	 ...
	 * @return \TrustPayments\Entity\AbstractEntity[]
	 */
	...
	public static function loadByFilters(\Registry $registry, array $filters){
		...
		$start = \TrustPaymentsHelper::instance($registry)->getLimitStart($page);
		$end = \TrustPaymentsHelper::instance($registry)->getLimitEnd($page);
