 ...
 * @method \TrustPayments\Sdk\Model\LineItemReduction[] getReductionItems()
 * @method void setReductionItems(\TrustPayments\Sdk\Model\LineItemReduction[] $reductions)
...
class RefundJob extends AbstractJob {
	...
	protected static function getTableName(){
		return 'trustpayments_refund_job';
	}
