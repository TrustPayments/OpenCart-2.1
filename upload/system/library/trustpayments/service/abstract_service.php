...
abstract class AbstractService {
	 ...
	 */
	protected function createEntityFilter($field_name, $value, $operator = \TrustPayments\Sdk\Model\CriteriaOperator::EQUALS){
	 ...
	 */
	protected function createEntityOrderBy($field_name, $sort_order = \TrustPayments\Sdk\Model\EntityQueryOrderByType::DESC){
