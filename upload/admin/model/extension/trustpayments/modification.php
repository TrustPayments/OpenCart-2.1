...
class ModelExtensionTrustPaymentsModification extends AbstractModel {

	public function install(){
		$path = DIR_SYSTEM . "library/trustpayments/modification/";
		$installedModifications = $this->getModificationModel()->getModifications();
		foreach (TrustPaymentsVersionHelper::getModifications() as $code => $modification) {
