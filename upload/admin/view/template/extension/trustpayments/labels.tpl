<!-- see model/extension/trustpayments/order.php & TrustPaymentsAdministration.ocmod.xml -->
<?php foreach($job_groups as $key => $job_group) : ?>
	<a class='h3' data-toggle='collapse' href='#trustpayments-jobs-<?php echo $key;?>' aria-controls='trustpayments-jobs-<?php echo $key;?>' aria-expanded='<?php echo $key == 0 ? 'true' : 'false'?>'
	><?php echo $job_group['title']; ?> <i class='fa fa-chevron-down'></i></a>
	
	<div id='trustpayments-jobs-<?php echo $key; ?>' class='collapse'>
